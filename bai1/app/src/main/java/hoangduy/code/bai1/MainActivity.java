        ...
        nut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lala.length() < 3) {
                    ...
                    } else if (sothich2.isChecked()) {
                        thich = sothich2.getText().toString();
                    }
                    if (sothichh3.isChecked()) {
                        thich = sothichh3.getText().toString();
                    }
                    String ketqua = "Thông Tin Cá Nhân" + "\n" + ten.getText().toString() + ":" + hoten.getText().toString() + "\n"
                            + cmnd.getText().toString() + ":" + cm.getText().toString() + "\n"
                            + bang.getText().toString() + ":" + thongtin + "\n"
                            + sothich.getText().toString() + ":" + thich + "\n"
                            + thongtinbosung.getText().toString() + ":" + thongtinbosungg.getText().toString();
